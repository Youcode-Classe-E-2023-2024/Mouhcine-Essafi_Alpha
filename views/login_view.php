                ...
                <div class="flex flex-col w-full md:w-1/2 p-4">
                    <div class="flex flex-col flex-1 justify-center mb-8">
                        ...
                        <div class="w-full mt-4">
                            <form class="form-horizontal w-3/4 mx-auto" id="loginForm">
                                <div class="flex flex-col mt-4">
                                    <input type="text" class="flex-grow h-8 px-2 border rounded border-grey-400" id="username" name="log_email" placeholder="Email">
                                </div>
                                <div class="flex flex-col mt-4">
                                    <input type="password" class="flex-grow h-8 px-2 rounded border border-grey-400" id="password" name="log_password" required placeholder="Password">
                                </div>
                                ...
                                <div class="flex flex-col mt-8">
                                    <button id="submitBtn" name="submit_l" type="submit" class="bg-blue-500 hover:bg-blue-700 text-white text-sm font-semibold py-2 px-4 rounded">
                                        Login
                                    </button>
                                </div>
                            </form>
